...
<p className="texto">Que tal amigo! En esta seccion te haremos varias preguntas las cuales tendran dos opciones de respuesta, de esta forma podremos obtener un poco mas de tu información para poder ayudarte ¡Vamos!</p>
<br></br>
<p className="preguntas"> 1.¿Crees que los malos habitos pueden dañar la convivencia familiar?</p>
...
<br></br>
<p className="preguntas"> 2.¿Cómo crees que es la convivencia en tu hogar?</p>
<div class="form-check">
  <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" checked/>
  <label class="form-check-label" for="exampleRadios1">
    Excelente
...
<br></br>
<p className="preguntas"> 3.¿Alguna ves te has sentido amenazado o discriminado por algun miembro de tu familia?</p>
<div class="form-check">
  <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" checked/>
  <label class="form-check-label" for="exampleRadios1">
    Casi siempre
...
<br></br>
<p className="preguntas"> 4.¿Que tan frecuente son las discuciones en tu hogar?</p>
<div class="form-check">
  <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" checked/>
  <label class="form-check-label" for="exampleRadios1">
    Diarias
...
<br></br>
<p className="preguntas"> 5.¿Hay fecuentes agresiones verbales o fisicas en tu hogar?</p>
<div class="form-check">
  <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" checked/>
  <label class="form-check-label" for="exampleRadios1">
    sí, casi siempre
...
<br></br>
<p className="preguntas"> 6.¿Qué tan buena es la comunicación en tu hogar?</p>
<div class="form-check">
  <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" checked/>
  <label class="form-check-label" for="exampleRadios1">
    Excelente
...
<br></br>
<p className="preguntas"> 7.¿En tu entorno familiar se ven frecuentes riñas o peleas?</p>
<div class="form-check">
  <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" checked/>
  <label class="form-check-label" for="exampleRadios1">
    Sí, casi siempre
...
<input class="btn btn-primary" type="button" value="Enviar"/><br></br><br></br>
<a href="https://jd51c.csb.app/alertas" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Siguente</a>
<a href="https://jd51c.csb.app/bienvenidos" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">Atras</a>
</div>
</div>
</>
